...
router.get("/delete/:inventory_id", utilities.handleErrors(invController.buildByDelete))
...
router.post("/delete/:inventory_id", utilities.handleErrors(invController.deleteInventory))
